...
topic = app.topic("udacity.chicago.stations", value_type=Station)
# TODO: Define the output Kafka Topic
# Topic should contain stations.table as this part is pattern matched in server.py
# This is the topic name used in server.py
